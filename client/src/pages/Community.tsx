            ...
            <div className="flex flex-wrap gap-3.5">
              {projects.map((project) => (
                ...
                >
                  ...
                  <div className="p-4 text-white bg-linear-180 from-transparent group-hover:from-indigo-950 to-transparent transition-colors">
                    ...
                    >
                      ...
                      <div className="flex gap-3 text-white text-sm">
                        <button className="px-3 py-1.5 bg-white/10 hover:bg-white/15 rounded-md transition-all">
                          <span className="bg-gray-200 size-4.5 rounded-full text-black font-semibold flex items-center justify-center">{`S`}</span>
                          {`sourav`}
                        </button>
                      </div>
                    </div>
                  ...
                  >
                    {/* <TrashIcon className="absolute top-3 right-3 scale-0 group-hover:scale-100 bg-white p-1.5 size-7 rounded text-red-500 text-xl cursor-pointer transistion-all" onClick={()=>deleteProject(project.id)}/> */}
                  </div>
                </Link>
              ))}
            </div>
