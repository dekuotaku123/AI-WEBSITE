        ...
        {loading ? (
          ...
          <div className="py-10 min-h-[80vh]">
            <div className="flex items-center justify-between mb-12">
              ...
              <button
                onClick={() => navigate("/")}
                className="flex items-center gap-2 text-white px-3 sm:px-6 py-1 sm:py-2 rounded bg-linear-to-br from-indigo-500 to-indigo-600 hover:capacity-90 active:scale-95 traansition-all"
              >
                <PlusIcon size={18} />
                Create New
              </button>
            ...
            <div className="flex flex-wrap gap-3.5">
              {projects.map((project) => (
                ...
                >
                  ...
                  >
                    <TrashIcon
                      className="absolute top-3 right-3 scale-0 group-hover:scale-100 bg-white p-1.5 size-7 rounded text-red-500 text-xl cursor-pointer transistion-all"
