  ...
  return (
    <>
      <nav className="z-50 flex items-center justify-between w-full py-4 px-4 md:px-16 lg:px-24 xl:px-32 backdrop-blur border-b text-white border-slate-800">
        ...
        <div className="hidden md:flex items-center transition duration-500 p-2">
          <div className="flex gap-8 hover:text-slate-300 transition">
            <Link to="/">Home</Link>
        ...
        <div className="flex item-center gap-3">
          {!session?.user?(
            ...
            className="px-6 py-1.5 max-sm:test-sm bg-indigo-600 active:scale-95 hover:bg-indigo-700 transition rounded-md">
            Get started
          </button>
          ):(
