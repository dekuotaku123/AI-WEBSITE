import { ScanLineIcon,SquareIcon,TriangleIcon } from "lucide-react";
import { useEffect, useState } from "react";

const steps = [
    {icon : ScanLineIcon,label : "Analyzing Your Request..."},
    {icon : SquareIcon,label : "Generating Layout Structure..."},
    {icon : TriangleIcon,label : "Assembling UI Componenets..."},
    {icon : TriangleIcon,label : "Finalizing your website..."},         
]
...
const LoaderSteps = ()=>{
    ...
    return(<div className="w-full h-full flex flex-col items-center justify-center bg-gray-950 relative overflow-hidden text-white">
